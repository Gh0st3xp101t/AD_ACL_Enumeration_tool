...
Outil d'énumération Active Directory pour identifier les permissions exploitables, les configurations dangereuses et les chemins d'escalade de privilèges dans un environnement CTF.
